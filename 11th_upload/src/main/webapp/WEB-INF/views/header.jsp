...
<title>Online Shopping</title>
 <strong><link rel="icon" href='resources/images/logo.png' type="image/png"></strong>
...
<body >
	...
	<div class="container-fluid">
		...
		<div>
			<a class="navbar-brand" href="viewall">view all</a>
		</div>
			...
			<form class="navbar-form" action="category" method="get">
				<center>
					...
					<c:if test="${!empty categoryList}">
						<c:forEach items="${categoryList}" var="admin">
				<option value=	"${admin.categoryname}">
		...
		<ul class="nav navbar-nav navbar-right">
			<li><sec:authorize access="isAnonymous()">
					<a href="memberShip.obj"><span class="glyphicon glyphicon-user"></span>Register</a>
				</sec:authorize></li>
			<c:if test="${pageContext.request.userPrincipal.name != null}">
				<li class="active"><a><b>Welcome:
