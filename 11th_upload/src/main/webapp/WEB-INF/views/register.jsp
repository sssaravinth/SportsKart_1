	...
	<div class="container">
		...
		<div>
			<form:form modelAttribute="register2">
				...
				<div class="form-group" >
					<form:label class="control-label col-sm-2" path="yourname" style="color: white">Enter YourName:</form:label>
					<div class="col-sm-4">
				...
				<div class="form-group">
					<form:label class="control-label col-sm-2" path="emailid" style="color: white">Enter Email ID:</form:label>
					<div class="col-sm-4">
				...
				<div class="form-group">
					<form:label class="control-label col-sm-2" path="enterpassword" style="color: white">Enter Password:</form:label>
					<div class="col-sm-4">
				...
				<div class="form-group">
					<form:label class="control-label col-sm-2" path="confirmpassword" style="color: white">Confirm Password:</form:label>
					<div class="col-sm-4">
