...
<%-- background="<c:url value='/resources/giphy.gif'/>" --%>
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img src="<c:url value='resources/images/bat1.jpg'/>" alt="Sports"
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-xs-6 col-sm-4" style="background-color: white;">
				<a href="allproduct?pdt=FootBall"><img src="<c:url value='/resources/images/d.jpg'/>"
			...
			<div class="col-xs-6 col-sm-4" style="background-color: white;">
				<a href="allproduct?pdt=Hockey"><img src="<c:url value='/resources/images/f.jpg'/>" alt="hockey"
					class="img-responsive" alt="Chania"
					style="width: 4000px; height: 370px" /></a>
			</div>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-xs-6 col-sm-4" style="background-color: white;">
				<a href="allproduct?pdt=VolleyBall"><img
